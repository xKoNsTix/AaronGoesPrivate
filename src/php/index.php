...
<?php wp_body_open(); ?>
    <header>
        <a href="/">
            <h1><span id="uppercase">Aaron G. Miller</span> | Choreographer</h1>
        </a>
        <nav id="mainnav">
    ...
    <main>
            ...
            <div class="mastergrid">
                <div class="level-1">
                    ...
                    <div class="level">
                        <div class="sublevel-1">
                            <h3>As pro as you can get</h3><br>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                incididunt ut
                                labore et dolore magna aliqua.
                            </p>
                            <a href="#" class="button">Book Workshop</a><br>
                        </div>
                        <div class="blockquote-1">
                            <img class="svg" src="<?php echo get_template_directory_uri();?>/images/quote.svg" alt='quote sign'>
                ...
                <div class="level-2">
                    <div class="iconsection">
                        ...
                        <div class="icon-2">
                            <img src="<?php echo get_template_directory_uri();?>/images/stretch.svg"
                ...
                <p class='register1'>Register now open for everybody!</p>
                <div class="level-3">
                    <div class="iconsection">
                ...
                <p class='register2'>Register now open for everybody!</p>
            </div>
        </section>
        <section id="workshops2">
            ...
            <div class="mastergrid">
                <div class="level-1">
                    <span class="number-3"><span class="numbi">3</span></span>
                    <div class="icon-1">
                        <div class="iconi">
                            <img src="<?php echo get_template_directory_uri();?>/images/rise.svg" alt='Icon showing dancer stretching her leg up to her nose.'>
                        </div>
                ...
                <p class='apply'>Apply for an audition now!</p>
                <div class="level-2">
                    <span class="number-2"><span class="numbi">2</span></span>
                    <div class="icon-2">
                        <div class="iconi">
                            <img src="<?php echo get_template_directory_uri();?>/images/stretch.svg"
                                alt='Icon showing dancer stretching her leg up to her nose.'>
                ...
                <p class='register1'>Register now open for everybody!</p>
                <div class="level-3">
                    <span class="number-1"><span class="numbi">1</span></span>
                    <div class="icon-3">
                        <div class="iconi">
                            <img src="<?php echo get_template_directory_uri();?>/images/up.svg" alt='Icon showing dancer stretching her leg up to her nose.'>
                        </div>
        ...
        <section id="about">
            <img src="<?php echo get_template_directory_uri();?>/images/Cheng_Tsung_Lung.jpeg" alt="Künstler Cheng Tsung Lung">
            <div class="metext">
                <p class="super-headline">Why I teach</p>
                <h2>Hi, I'm Aaron!</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat itaque incidunt, nihil,
                    recusandae autem aut perferendis reiciendis a neque veniam quibusdam animi ex tempora
                    reprehenderit, aspernatur asperiores consequatur consectetur ipsum!</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat itaque incidunt, nihil,
                    recusandae autem aut perferendis reiciendis a neque veniam quibusdam animi ex tempora
                    reprehenderit, aspernatur asperiores consequatur consectetur ipsum! Lorem ipsum dolor sit amet
                    consectetur adipisicing elit. Placeat itaque incidunt, nihil, recusandae autem aut perferendis
                    reiciendis a neque veniam quibusdam animi ex tempora reprehenderit, aspernatur asperiores
                    consequatur consectetur ipsum!</p>
        ...
        <section id="news">
            ...
            <div class="newssection">
                <article>
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/images/article1.jpeg" alt="Aaron performing at the Sydney dance festival 2022">
                    <p>
                ...
                <article>
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/images/article2.jpeg" alt="Group picture of 'Dance Pool'">
                    <p>
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                        sed diam nonumy eirmod tempor invidunt ut labore et
                        dolore magna aliquyam erat, sed diam voluptua. At vero
                ...
                <article>
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/images/article3.jpeg" alt="Aaron at a workshop">
                    <p>
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                        sed diam nonumy eirmod tempor invidunt ut labore et
                        dolore magna aliquyam erat, sed diam voluptua. At vero
    ...
    <footer>
        <div id="footer_left">
            <h3>Thank you for your interest in Art!</h3>
